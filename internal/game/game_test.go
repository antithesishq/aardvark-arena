...
func TestPlayerOpponentInvolution(t *testing.T) {
	t.Run("opponent of opponent is self", func(t *testing.T) {
	...
	t.Run("opponent is different from self", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
			p := hegel.Draw(ht, hegel.SampledFrom([]Player{P1, P2}))
			if p.Opponent() == p {
...
func TestPositionMarshalRoundtrip(t *testing.T) {
	t.Run("MarshalText -> UnmarshalText recovers original", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
...
func TestKindUnmarshalRejectsInvalid(t *testing.T) {
	t.Run("invalid text is rejected", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
...
func TestInBoundsCorrectness(t *testing.T) {
	t.Run("matches manual check", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
...
func TestStatusIsTerminal(t *testing.T) {
	t.Run("only Active is non-terminal", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
...
func TestTicTacToeMoveProperties(t *testing.T) {
	t.Run("valid move occupies exactly one cell", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
	...
	t.Run("non-terminal move switches current player", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
			state := NewState(NewTicTacToeBoard())
			session := &TicTacToeSession{}
...
func TestConnect4GravityProperty(t *testing.T) {
	t.Run("piece lands at lowest empty row", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
	...
	t.Run("full column is rejected", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
			state := NewState(NewConnect4Board())
			session := &Connect4Session{}
