...
func TestCalcEloProperties(t *testing.T) {
	t.Run("zero-sum: total ELO is conserved", func(t *testing.T) {
	...
	t.Run("winner never loses ELO on a win", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
			winnerElo := hegel.Draw(ht, hegel.Integers[int](0, 4000))
			loserElo := hegel.Draw(ht, hegel.Integers[int](0, 4000))
	...
	t.Run("loser never gains ELO on a loss", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
			winnerElo := hegel.Draw(ht, hegel.Integers[int](0, 4000))
			loserElo := hegel.Draw(ht, hegel.Integers[int](0, 4000))
	...
	t.Run("draw between equal players changes nothing", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
	...
	t.Run("underdog gains at least as much as favorite on win", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
...
func TestMatchEloProperties(t *testing.T) {
	t.Run("symmetric: order of players does not matter", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
	...
	t.Run("close ELO always matches", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
	...
	t.Run("ELO difference is non-negative", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
			a := hegel.Draw(ht, hegel.Integers[int](0, 4000))
			b := hegel.Draw(ht, hegel.Integers[int](0, 4000))
			now := time.Now()
	...
	t.Run("longer wait relaxes threshold", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
...
func TestCalcEloRobustness(t *testing.T) {
	t.Run("no crash on extreme ELO values", func(t *testing.T) {
		hegel.Test(t, func(ht *hegel.T) {
